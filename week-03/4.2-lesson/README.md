...
> This is a more complicated topic than the previous lessons and you will likely spend more time lecturing. Try to make good use of the included [instructor plot notebook](./code/w3-lesson2.1-plots.ipynb) whenever you need to run the plots described in this lesson, and spend more time in the [demo notebook](./code/starter-code/Bias-Variance-starter.ipynb) as needed.
...
> Use the [included demo notebook](./code/starter-code/Bias-Variance-starter.ipynb) to demo a series of models and explore both the bias and the variance.
